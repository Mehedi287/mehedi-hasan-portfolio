...
const MyService = () => {
    return (
        <div className="mt-5">
            <h1 data-aos="flip-up" data-aos-duration="2500"><span className="my2">My</span> <span className="ser">Services</span></h1>
            <hr className="mb-5 hr3" data-aos="flip-right" data-aos-duration="2500" />
            <div className="d-flex row g-4 mx-auto">
                <div className="col-md-4 ">
                    <div className="service" data-aos="zoom-out-left" data-aos-duration="1800">
                ...
                <div className="col-md-4 mx-auto">
                    <div className="service" data-aos="zoom-out-up" data-aos-duration="1800">
                ...
                <div className="col-md-4 mx-auto">
                    <div className="service" data-aos="zoom-out-right" data-aos-duration="1800">
